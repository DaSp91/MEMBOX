 ...
 *        tra i clients ed il server membox (sono implementate in connections.c)
 */
...
/**
 * @function openConnectionServer(funzione aggiunta dagli autori) 
 * @brief Apre una connessione AF_UNIX per il server membox.
 *
 * @param path Path del socket AF_UNIX
 *
 * @return il descrittore associato alla connessione in caso di successo
